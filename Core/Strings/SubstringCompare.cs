...
{
    /// <summary>
    /// Provides utility methods for the comparing substrings within <see cref="string"/> instances.
    /// </summary>
    public static class SubstringCompare
    {
        /// <summary>
        /// Compares substrings of two specified strings using the specified rules, 
        ...
        /// (<see href="http://referencesource.microsoft.com/#mscorlib/system/string.cs,1ae4d07b01230bb6">source</see>)
        /// and <see cref="string.IndexOf(string, int, int, StringComparison)"/>
        /// (<see href="http://referencesource.microsoft.com/#mscorlib/system/string.cs,ef82268cfee756fe">source</see>).
        /// </para>
        /// </remarks>
