...
> **Archived**: This project has been archived and is no longer maintained.
  Several parts of it have been rendered obsolete or outdated due to improvements
  in subsequently released versions of C# and the .NET platform,
  so one should review and adapt accordingly before applying it to modern projects.
